...
namespace MaillotStore.Migrations
{
    ...
    [Migration("20260213115156_AddMarketingAsset")]
    partial class AddMarketingAsset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaillotStore.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MaillotStore.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MaillotStore.Models.MarketingAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MaillotStore.Models.Order", b =>
                {
                    ...
                    b.Property<bool>("IsVisibleToInfluencer")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MaillotStore.Data.ApplicationUser", null)
                        .WithMany()
